...
<!-- Mirrored from codeminifier.com/rikada-template/rikada/home-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2019 16:41:26 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

    <title>FIBIAC - Powerful Residence Real Estate Site in Port Harcourt</title>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="cn-info">
                        <ul>
                            <li><i class="lni-phone-handset"></i>234 0902 6190 497</li>
                            <li><i class="ti-email"></i>Info@fibiachome.com</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
    ...
    <div class="header header-light nav-left-side">
        <nav class="headnavbar">
            ...
            <!-- <ul class="attributes attributes-desk">
                ...
                <li class="submit-attri theme-log"><a href="submit-property.php">Submit Property</a></li>
            </ul> -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            <h4 class="widget-title">About fibiachome</h4>
                            <p>fibiachome features homes for sale in all states. fibiachome online search portal of property listings gives you the ability to refine your search criteria by different factors, including geographical location.</p>
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="fw-address-wrap">
                                <div class="fw fw-location">
                                    #2 ambassador Joe ehoro cressent elelenwo
                                </div>
                                <div class="fw fw-mail">
                                    <a href="https://codeminifier.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="94e7e1e4e4fbe6e0d4f0e6fdeee2f5e0fba3a3baf7fbf9">[email&#160;protected]</a>
                                </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-12 col-md-12 text-center">
                        <p class="mb-0">© 2019 fibiachome. Designd By <a href="#">Simvic</a> All Rights Reserved</p>
                    </div>
...
<script src="{{ asset('assets/js/custom.js')}}"></script><script src="assets/js/cl-switch.js"></script>
<!-- ============================================================== -->
<!-- This page plugins -->
<!-- ============================================================== -->
