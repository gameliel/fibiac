							...
							<div class="property_item classical-list">
								<div class="image">
									<a href="single-property-3.html">
										<img src="{{ $listing->gallery }}" alt="latest property" class="img-fluid">
									</a>
									<div class="sb-date">
										<span class="tag"><i class="ti-calendar"></i>4 days ago</span>
									</div>
									<span class="tag_t">{{ $listing->status }}</span>
								</div>
								<div class="proerty_content">
									<div class="proerty_text">
									  <h3 class="captlize"><a href="single-property-3.html">{{ $listing->title }}</a></h3>
									  <p class="proerty_price">{{ $listing->price }}</p>
									</div>
									<p class="property_add">{{ $listing->address }}</p>
									<div class="property_meta">
									  <div class="list-fx-features">
											<div class="listing-card-info-icon">
												<span class="inc-fleat inc-bed">{{ $listing->bedroom }}</span>
											</div>
											<div class="listing-card-info-icon">
												<span class="inc-fleat inc-type">{{ $listing->type }}</span>
											</div>
											<div class="listing-card-info-icon">
												<span class="inc-fleat inc-area">{{ $listing->area }}</span>
											</div>
											<div class="listing-card-info-icon">
												<span class="inc-fleat inc-bath">{{ $listing->bathroom }}</span>
											</div>
										</div>
									</div>
