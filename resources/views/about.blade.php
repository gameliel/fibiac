					...
					<div class="row align-items-center">
						...
						<div class="col-lg-6 col-md-6">
							<div class="story-wrap explore-content">
								...
								<h2>Our Story</h2>
								<p>fibiachomes is Nigeria’s first “On-demand Home Rental Solution” with flexible payment and rent insurance.
									Our day-to-day focus is to make it possible for you to seamlessly find a new home that suits your need, within your budget.</p>
									<p>We’ve removed the headache of agency and legal fees which add up and put you off from getting a new home. You deserve a simplified rental experience!</p>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6">
							...
							<div class="icon-mi-left">
								...
								<div class="icon-mi-left-content">
									<h4>Mission</h4>
									<p>We exist to provide global top class services to humanity in the area of our core competences that leave our clients happy and thoroughly satisfied.</p>
								</div>
							</div>
							...
							<div class="icon-mi-left">
								...
								<div class="icon-mi-left-content">
									<h4>Vision</h4>
									<p>To be the foremost Company in Nigeria providing world class real estate, interior decoration, power supply & installation, and car renting services that meet our clients’ needs at all times, effectively and efficiently.</p>
								</div>
							</div>
							...
							<div class="icon-mi-left">
								...
								<div class="icon-mi-left-content">
									<h4>Core Values</h4>
									<p>Keep our clients satisfied; our colleagues / collaborators happy; our staffs fulfilled and motivated; our management proud, innovative and celebrated; our brand competitive and progressive through environmental friendly and sustainable development practices.</p>
								</div>
							</div>
