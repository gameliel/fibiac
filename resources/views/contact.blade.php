					...
					<div class="col-lg-7 col-md-7">
						...
						<div class="col-lg-5 col-md-5">
							<div class="contact-info">
								...
								<h2>Get In Touch</h2>
								<p>Whether you need a local Agent or have a question about our site, we’re here to help. </p>
								<div class="cn-info-detail">
									...
									<div class="cn-info-content">
										...
										#2 ambassador joe ehoro cressent school road<br>elelenwo, port Harcourt
									</div>
								</div>
								...
								<div class="cn-info-detail">
									...
									<div class="cn-info-content">
										...
										<a href="#" class="__cf_email__" data-cfemail="21525451514e53556173484a4045400f424e4c">Info@fibiachome.com</a><br><a href="#">contact@fibiachome.com</a>
									</div>
								</div>
